...
Examples of usage and demonstration of abilities of hierarchical algorithm in cluster analysis.
...
from pyclustering.clustering.hierarchical import hierarchical;
