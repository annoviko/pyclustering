...
from pyclustering.clustering.xmeans import xmeans, splitting_type;
...
class Test(unittest.TestCase):
    def templateLengthProcessData(self, path_to_file, start_centers, expected_cluster_length, ccore = False):
        ...
        xmeans_instance = xmeans(sample, start_centers, 20, 0.025, splitting_type.BAYESIAN_INFORMATION_CRITERION, ccore);
