...
Examples of usage and demonstration of abilities of Hierarchical Sync (HSyncNet) algorithm in cluster analysis.
...
from pyclustering.clustering.hsyncnet import hsyncnet;
