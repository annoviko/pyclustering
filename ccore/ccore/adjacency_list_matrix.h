#ifndef _ADJACENCY_LIST_MATRIX_H_
#define _ADJACENCY_LIST_MATRIX_H_

#include "adjacency.h"


template <class TypeNode> using adjacency_list_matrix_container = std::vector<std::unordered_set<TypeNode>>;
...
*
***********************************************************************************************/
class adjacency_list_matrix : public adjacency_collection<size_t, adjacency_list_matrix_container> {
private:
...
public:
    ...
    *
    * @details Complexity eqauls to complexity of searching element in std::unordered_set.
    *
