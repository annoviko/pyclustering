...
class Test(unittest.TestCase):  
    def templateLengthProcessData(self, path_to_file, radius, cluster_numbers, threshold, expected_cluster_length):
        sample = read_sample(path_to_file);
        
        clusters = rock(sample, radius, cluster_numbers, threshold);
