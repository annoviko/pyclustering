...
class SIMPLE_SAMPLES:
    SAMPLE_SIMPLE1          = samples.__path__[0] + os.sep + "SampleSimple1.txt";
    SAMPLE_SIMPLE2          = samples.__path__[0] + os.sep + "SampleSimple2.txt";
...
class FCPS_SAMPLES:
    SAMPLE_ATOM             = samples.__path__[0] + os.sep + "SampleAtom.txt";
    SAMPLE_CHAINLINK        = samples.__path__[0] + os.sep + "SampleChainlink.txt";
    SAMPLE_ENGY_TIME        = samples.__path__[0] + os.sep + "SampleEngyTime.txt";
    SAMPLE_GOLF_BALL        = samples.__path__[0] + os.sep + "SampleGolfBall.txt";
    SAMPLE_HEPTA            = samples.__path__[0] + os.sep + "SampleHepta.txt";
    SAMPLE_LSUN             = samples.__path__[0] + os.sep + "SampleLsun.txt";
    SAMPLE_TARGET           = samples.__path__[0] + os.sep + "SampleTarget.txt";
    SAMPLE_TETRA            = samples.__path__[0] + os.sep + "SampleTetra.txt";
    SAMPLE_TWO_DIAMONDS     = samples.__path__[0] + os.sep + "SampleTwoDiamonds.txt";
    SAMPLE_WING_NUT         = samples.__path__[0] + os.sep + "SampleWingNut.txt";
